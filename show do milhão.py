...
if Máteria_selecionada == "1":
    ...
    gerenciar_pergunta(4, "A densidade demográfica corresponde:",
                       {"A": "Ao número de idosos", "B": "Ao número de habitantes por área", "C": "Ao número de nascimentos", "D": "Ao tamanho das cidades", "E": "Ao número de migrantes"}, "B", 400.0)

    gerenciar_pergunta(5, "Quando o número de nascimentos é maior que o de mortes, ocorre:",
                       {"A": "Crescimento vegetativo positivo", "B": "Êxodo rural", "C": "Migração internacional", "D": "Urbanização", "E": "Redução populacional"}, "A", 400.0)
    ...
    gerenciar_pergunta(6, "O deslocamento de pessoas de um lugar para outro recebe o nome de:",
                       {"A": "Industrialização", "B": "Urbanização", "C": "Migração", "D": "Globalização", "E": "Colonização"}, "C", 1000.0)

    gerenciar_pergunta(7, "Quando uma pessoa entra em um país para morar nele, ocorre:",
                       {"A": "Emigração", "B": "Imigração", "C": "Êxodo rural", "D": "Natalidade", "E": "Urbanização"}, "B", 2000.0)

    get_pergunta = gerenciar_pergunta(8, "Quando uma pessoa deixa seu país de origem para viver em outro, ocorre:",
                       {"A": "Imigração", "B": "Urbanização", "C": "Natalidade", "D": "Emigração", "E": "Industrialização"}, "D", 3000.0)

    gerenciar_pergunta(9, "O êxodo rural corresponde:",
                       {"A": "À saída da cidade para o campo", "B": "À chegada de estrangeiros", "C": "À saída do campo para a cidade", "D": "Ao crescimento industrial", "E": "À redução da população"}, "C", 4000.0)

    gerenciar_pergunta(10, "Um dos principais motivos do êxodo rural é:",
                       {"A": "Busca por empregos e serviços urbanos", "B": "Aumento das áreas agrícolas", "C": "Redução das cidades", "D": "Crescimento da natalidade", "E": "Mudança climática global"}, "A", 5000.0)

    # --- TEMA 3 ---
    input(" 🎤 Vamos avançar: \n Terceiro Tema: Desigualdade Econômica e IDH \n Dificuldade: 😡 Difícil 😡 \n\n | ENTER | \n")

    gerenciar_pergunta(11, "O IDH significa:",
                       {"A": "Índice de Desenvolvimento Habitacional", "B": "Índice de Desenvolvimento Humano", "C": "Indicador Demográfico Humano", "D": "Instituto de Desenvolvimento Humano", "E": "Índice de Distribuição Habitacional"}, "B", 10000.0)

    gerenciar_pergunta(12, "Qual dos fatores abaixo é utilizado no cálculo do IDH?",
                       {"A": "Quantidade de rios", "B": "Produção agrícola", "C": "Educação", "D": "Número de montanhas", "E": "Extensão territorial"}, "C", 15000.0)

    gerenciar_pergunta(13, "Uma medida que pode ajudar a reduzir as desigualdades econômicas é:",
                       {"A": "Diminuir o acesso à educação", "B": "Reduzir empregos", "C": "Investir em educação e qualificação", "D": "Aumentar a exclusão social", "E": "Fechar escolas públicas"}, "C", 20000.0)

    gerenciar_pergunta(14, "Além da educação, o IDH também considera:",
                       {"A": "Saúde e renda", "B": "Vegetação e clima", "C": "Relevo e hidrografia", "D": "Mineração e agricultura", "E": "Comércio e turismo"}, "A", 30000.0)

    gerenciar_pergunta(15, "Um país com alto IDH geralmente apresenta:",
                       {"A": "Baixa qualidade de vida", "B": "Pouco acesso à educação", "C": "Baixa expectativa de vida", "D": "Melhores condições de vida", "E": "Ausência de serviços públicos"}, "D", 50000.0)
    
    # --- TEMA 4 ---
    print(input(" 🎤 Vamos dar início: \n Quarto Tema: Meio Ambiente \n Dificuldade: 😡 Difícil 😡 \n\n | ENTER | \n"))

    gerenciar_pergunta(16, "Qual é o principal gás responsável pelo efeito estufa intensificado?",
                       {"A": "Oxigênio", "B": "Nitrogênio", "C": "Dióxido de Carbono (CO₂)", "D": "Hidrogênio", "E": "Hélio"}, "C", 75000.0)

    gerenciar_pergunta(17, "O desmatamento da Amazônia contribui principalmente para:",
                       {"A": "Aumento da biodiversidade", "B": "Redução das chuvas", "C": "Formação de geleiras", "D": "Diminuição do efeito estufa", "E": "Resfriamento global"}, "B", 100000.0)

    gerenciar_pergunta(18, "Qual prática contribui para o desenvolvimento sustentável?",
                       {"A": "Desperdício de água", "B": "Queimadas frequentes", "C": "Reciclagem de materiais", "D": "Poluição dos rios", "E": "Desmatamento"}, "C", 150000.0)

    gerenciar_pergunta(19, "O aquecimento global está relacionado principalmente:",
                       {"A": "Ao aumento dos gases de efeito estufa", "B": "À diminuição da população", "C": "Ao aumento da pesca", "D": "À formação de vulcões", "E": "À redução das cidades"}, "A", 200000.0)

    gerenciar_pergunta(20, "Qual dos problemas abaixo é considerado um impacto ambiental urbano?",
                       {"A": "Poluição do ar", "B": "Formação de montanhas", "C": "Movimento das placas tectônicas", "D": "Erosão glacial", "E": "Marés oceânicas"}, "A", 250000.0)
    ...
    gerenciar_pergunta(21, "Qual instrumento é utilizado para determinar coordenadas geográficas por satélite?",
                       {"A": "Bússola", "B": "GPS", "C": "Barômetro", "D": "Termômetro", "E": "Altímetro"}, "B", 300000.0)

    gerenciar_pergunta(22, "Os paralelos são linhas imaginárias utilizadas para medir:",
                       {"A": "Longitude", "B": "Altitude", "C": "Latitude", "D": "Distância", "E": "Profundidade"}, "C", 350000.0)

    gerenciar_pergunta(23, "O Meridiano de Greenwich corresponde a:",
                       {"A": "Latitude 0°", "B": "Longitude 0°", "C": "Trópico de Capricórnio", "D": "Linha do Equador", "E": "Polo Norte"}, "B", 400000.0)

    gerenciar_pergunta(24, "A disputa por territórios, recursos e influência entre países é estudada principalmente pela:",
                       {"A": "Meteorologia", "B": "Cartografia", "C": "Demografia", "D": "Geopolítica", "E": "Oceanografia"}, "D", 450000.0)
