...
# === ABERTURA DO JOGO ===
    ...
    Ajuda_d_plateia = 5
    Ajuda_dos_Uni = 3
    print("=== Bem-vindo ao CYBER MIND SHOW ===")
    ...
    print("Vamos dar início ao primeiro Tema: Reconhecimento dos processos de divisão celular (Biologia) 🌿")
    ...
    print (input(" 🎤 Cada pergunta vale uma quantia de dinheiro 💵  \n  A cada acerto o valor da próxima pergunta aumenta, crescendo o resultado acumulado \n  Mas se você errar, o jogo acaba na hora! \n\n | ENTER | \n"))
    ...
    def RESPOSTAS_PERGUNTA_1 (pergunta_1_resposta_q):
        global Ajuda_plateia
        global Ajuda_Universitarios
        global Valor_Acumulado

        while True:
            pergunta_1_resposta_q = input("Para aquecer vamos começar o nível fácil resolvendo perguntas do tema:\n Eficiência Energética dos Combustíveis \n\n 🎤 Pergunta número 1: \n\n O que significa eficiência energética de um combustível? \n\n 🎤 Alternativa A) A quantidade de fumaça produzida pelo combustível. \n 🎤 Alternativa B) A capacidade do combustível gerar energia útil com pouco desperdício. \n 🎤 Alternativa C) A cor da chama produzida na combustão. \n 🎤 Alternativa D) A velocidade de abastecimento do veículo. \n 🎤 Alternativa E) A quantidade de combustível armazenada no tanque. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸  PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
        
            # .upper() serve para aceitar letras minúsculas digitadas pelo usuário
            pergunta_1_resposta_q = pergunta_1_resposta_q.upper()

            if pergunta_1_resposta_q == "P":
                if Ajuda_plateia > 0:
                    Ajuda_plateia -= 1
                    print (input("\n 🎤 Você pediu a ajuda da Plateia: \n Eles não têm certeza de qual seja a certa, então boa sorte! \n\n | ENTER | "))
                    print (" 🥸  É Alternativa (B)! \n 🥸  Claro que é (B)! \n 🥸  Óbvio que é (B)! \n\n")
            ...
            if pergunta_1_resposta_q in ["A", "C", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou! \n\n O valor acumulado foi de R$ " + str(Valor_Acumulado) + " \n\n Obrigado por jogar o Cyber Mind Show, " + nome_usuario + "! \n\n | ENTER | \n")
                exit()
    ...
    def RESPOSTAS_PERGUNTA_2 (pergunta_2_resposta_q):
        global Ajuda_plateia
        global Ajuda_Universitarios
        global Valor_Acumulado

        while True:
            pergunta_2_resposta_q = input("🎤 Pergunta número 2: \n\n Qual é um dos benefícios de utilizar combustíveis mais eficientes? \n\n 🎤 Alternativa A) Aumento do desperdício de energia. \n 🎤 Alternativa B) Maior emissão de poluentes. \n 🎤 Alternativa C) Redução do consumo de combustível. \n 🎤 Alternativa D) Diminuição da potência dos motores. \n 🎤 Alternativa E) Aumento da produção de resíduos. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n 👤 ")
        
         # .upper() serve para aceitar letras minúsculas digitadas pelo usuário
            pergunta_2_resposta_q = pergunta_2_resposta_q.upper()

            if pergunta_2_resposta_q == "P":
                if Ajuda_plateia > 0:
                    Ajuda_plateia -= 1
                    print (input("\n 🎤 Você pediu a ajuda da Plateia: \n Eles não têm certeza de qual seja a certa, então boa sorte! \n\n | ENTER | "))
                    print (" 🥸  É Alternativa (A)! \n 🥸  Claro que é (C)! \n 🥸  Óbvio que é (C)! \n\n")
            ...
            if pergunta_2_resposta_q == "U":
                if Ajuda_Universitarios > 0:
                    Ajuda_Universitarios -= 1
                    print (input("\n 🎤 Você pediu a ajuda do Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                    print (" 🎓  Tá fácil, todas erradas \n Menos a alternativa (C) \n\n ")
                    print (input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))

                else:
                    print (input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))

            if pergunta_2_resposta_q == "C":
                Valor_Acumulado = 2000.0
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 1000,00! \nPremio acumulado de R$ 2000,00\n Vamos prosseguir para a pergunta 3")
                input(" | ENTER | \n")
                break
    
            if pergunta_2_resposta_q in ["A", "B", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou! \n\n O valor acumulado foi de R$ " + str(Valor_Acumulado) + " \n\n Obrigado por jogar o Cyber Mind Show, " + nome_usuario + "! \n\n | ENTER | \n")
                exit()
    ...
    def RESPOSTAS_PERGUNTA_3 (pergunta_3_resposta_q):
        global Ajuda_plateia
        global Ajuda_Universitarios
        global Valor_Acumulado

        while True:
            pergunta_3_resposta_q = input(" 🎤 PERGUNTA 3:\n\n O poder calorífico de um combustível indica: \n\n 🎤 Alternativa A) Sua temperatura ambiente. \n 🎤 Alternativa B) A quantidade de energia liberada durante a combustão. \n 🎤 Alternativa C) A quantidade de água presente no combustível. \n 🎤 Alternativa D) O tempo que leva para ser produzido. \n 🎤 Alternativa E) A cor do combustível. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸  PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
        
            # .upper() serve para aceitar letras minúsculas digitadas pelo usuário
            pergunta_3_resposta_q = pergunta_3_resposta_q.upper()

            if pergunta_3_resposta_q == "P":
                if Ajuda_plateia > 0:
                    Ajuda_plateia -= 1
                    print (input("\n 🎤 Você pediu a ajuda da Plateia: \n Eles não têm certeza de qual seja a certa, então boa sorte! \n\n | ENTER | "))
                    print (" 🥸  É Alternativa (B)! \n 🥸  Claro que é (B)! \n 🥸  Óbvio que é (B)! \n\n")
            ...
            if pergunta_3_resposta_q in ["A", "C", "D", "E"]:     
                print("\n🎤 Resposta incorreta! O jogo acabou! \n\n O valor acumulado foi de R$ " + str(Valor_Acumulado) + " \n\n Obrigado por jogar o Cyber Mind Show, " + nome_usuario + "! \n\n | ENTER | \n")
                exit()
    ...
    def RESPOSTAS_PERGUNTA_4 (pergunta_4_resposta_q):
        global Ajuda_plateia
        global Ajuda_Universitarios
        global Valor_Acumulado

        while True:
            pergunta_4_resposta_q = input(" 🎤 PERGUNTA 4:\n\n Qual fator pode reduzir a eficiência energética de um veículo? \n\n 🎤 Alternativa A) Motor bem regulado. \n 🎤 Alternativa B) Combustível de boa qualidade. \n 🎤 Alternativa C) Manutenção em dia. \n 🎤 Alternativa D) Motor com peças desgastadas. \n 🎤 Alternativa E) Pneus calibrados corretamente. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸  PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
        
            # .upper() serve para aceitar letras minúsculas digitadas pelo usuário
            pergunta_4_resposta_q = pergunta_4_resposta_q.upper()

            if pergunta_4_resposta_q == "P":
                if Ajuda_plateia > 0:
                    Ajuda_plateia -= 1
                    print (input("\n 🎤 Você pediu a ajuda da Plateia: \n Eles não têm certeza de qual seja a certa, então boa sorte! \n\n | ENTER | "))
                    print (" 🥸  É Alternativa (D)! \n 🥸  Claro que é (D)! \n 🥸  Óbvio que é (D)! \n\n")
            ...
            if pergunta_4_resposta_q == "D":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 1000,00! \nValor acumulado: R$ 4000,00 \n Vamos prosseguir para a pergunta 5")
                input(" | ENTER | \n")
                Valor_Acumulado = 4000.0
                break

            if pergunta_4_resposta_q in ["A", "B", "C", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou! \n\n O valor acumulado foi de R$ " + str(Valor_Acumulado) + " \n\n Obrigado por jogar o Cyber Mind Show, " + nome_usuario + "! \n\n | ENTER | \n")
                exit()
    ...
    def RESPOSTAS_PERGUNTA_5 (pergunta_5_resposta_q):
        global Ajuda_plateia
        global Ajuda_Universitarios
        global Valor_Acumulado

        while True:
            pergunta_5_resposta_q = input(" 🎤 PERGUNTA 5:\n\n Por que a eficiência energética é importante para o meio ambiente? \n\n 🎤 Alternativa A) Porque aumenta a quantidade de lixo produzido. \n 🎤 Alternativa B) Porque reduz a necessidade de combustível e a emissão de poluentes. \n 🎤 Alternativa C) Porque torna os motores mais pesados. \n 🎤 Alternativa D) Porque aumenta o consumo de recursos naturais. \n 🎤 Alternativa E) Porque aumenta a produção de gases poluentes. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸  PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
        
            # .upper() serve para aceitar letras minúsculas digitadas pelo usuário
            pergunta_5_resposta_q = pergunta_5_resposta_q.upper()

            if pergunta_5_resposta_q == "P":
                if Ajuda_plateia > 0:
                    Ajuda_plateia -= 1
                    print (input("\n 🎤 Você pediu a ajuda da Plateia: \n Eles não têm certeza de qual seja a certa, então boa sorte! \n\n | ENTER | "))
                    print (" 🥸  É Alternativa (B)! \n 🥸  Claro que é (B)! \n 🥸  Óbvio que é (B)! \n\n")
            ...
            if pergunta_5_resposta_q == "U":
                if Ajuda_Universitarios > 0:
                    Ajuda_Universitarios -= 1
                    print (input("\n 🎤 Você pediu a ajuda do Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                    print (" 🎓  O desenvolvedor sabe que não escapa da gente? \n Está me parecendo a... (B)\n\n ")
                    print (input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))

                else:
                    print (input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))

            if pergunta_5_resposta_q == "B":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 1000,00!")
                input(" | ENTER | \n")
            ...
            if pergunta_5_resposta_q in ["A", "C", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou! \n\n O valor acumulado foi de R$ " + str(Valor_Acumulado) + " \n\n Obrigado por jogar o Cyber Mind Show, " + nome_usuario + "! \n\n | ENTER | \n")
                exit()
    ...
    def RESPOSTAS_PERGUNTA_6 (pergunta_6_resposta_m):
        ...
        while True:
            pergunta_6_resposta_m = input("Meus parabens por ter passado pelo nível fácil!!! \n Vamos começar com as perguntas de nível médio!!! \n O tema agora será Pilhas e Baterias!!! \n\n 🎤 PERGUNTA 6:\n\n Qual é a principal função de uma pilha ou bateria? \n\n 🎤 Alternativa A) Produzir luz diretamente. \n 🎤 Alternativa B) Armazenar energia térmica. \n 🎤 Alternativa C) Transformar energia química em energia elétrica. \n 🎤 Alternativa D) Transformar energia elétrica em energia química. \n 🎤 Alternativa E) Produzir energia nuclear. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸  PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            ...
            if pergunta_6_resposta_m == "C":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 5000,00!\nValor acumulado: R$ 10000,00 \n Vamos prosseguir para a pergunta 7")
                input(" | ENTER | \n")
                Valor_Acumulado = 10000.0
                break

            if pergunta_6_resposta_m in ["A", "B", "D", "E"]:
                 print("\n🎤 Resposta incorreta! O jogo acabou! \n\n O valor acumulado foi de R$ " + str(Valor_Acumulado) + " \n\n Obrigado por jogar o Cyber Mind Show, " + nome_usuario + "! \n\n | ENTER | \n")
                 exit()
    ...
    def RESPOSTAS_PERGUNTA_7 (pergunta_7_resposta_m):
        ...
        while True:
            pergunta_7_resposta_m = input("🎤 PERGUNTA 7:\n\n Em uma pilha, qual componente é responsável por liberar elétrons durante a reação química?"" \n\n 🎤 Alternativa A) Cátodo. \n 🎤 Alternativa B) Ânodo. \n 🎤 Alternativa C) Eletrólito. \n 🎤 Alternativa D) Sepador. \n 🎤 Alternativa E) Terminal. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸  PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            ...
            if pergunta_7_resposta_m == "B":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 10000,00! Valor acumulado: R$ 20000,00 \n Vamos prosseguir para a pergunta 8")
                input(" | ENTER | \n")
                Valor_Acumulado = 20000.0
                break

            if pergunta_7_resposta_m in ["A", "C", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou! \n\n O valor acumulado foi de R$ " + str(Valor_Acumulado) + " \n\n Obrigado por jogar o Cyber Mind Show, " + nome_usuario + "! \n\n | ENTER | \n")
                exit()
    ...
    def RESPOSTAS_PERGUNTA_8 (pergunta_8_resposta_m):
        ...
        while True:
            pergunta_8_resposta_m = input("🎤 PERGUNTA 8:\n\n O que diferencia uma bateria recarregável de uma pilha comum?"" \n\n 🎤 Alternativa A) A bateria possui mais energia que qualquer pilha. \n 🎤 Alternativa B) A pilha comum não utiliza reações químicas. \n 🎤 Alternativa C) A bateria recarregável pode ter suas reações químicas parcialmente revertidas por meio de recarga. \n 🎤 Alternativa D) A bateria não possui polos positivo e negativo. \n 🎤 Alternativa E) A pilha comum não produz eletricidade. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸  PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            ...
            if pergunta_8_resposta_m == "C":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 10000,00! Valor acumulado: R$ 30000,00 \n Vamos prosseguir para a pergunta 9")
                input(" | ENTER | \n")
                Valor_Acumulado = 30000.0
                break

            if pergunta_8_resposta_m in ["A", "B", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou! \n\n O valor acumulado foi de R$ " + str(Valor_Acumulado) + " \n\n Obrigado por jogar o Cyber Mind Show, " + nome_usuario + "! \n\n | ENTER | \n")
                exit()
    ...
    def RESPOSTAS_PERGUNTA_9 (pergunta_9_resposta_m):
        ...
        while True:
            pergunta_9_resposta_m = input("🎤 PERGUNTA 9:\n\n Por que pilhas e baterias não devem ser descartadas no lixo comum?"" \n\n 🎤 Alternativa A) Porque ocupam muito espaço. \n 🎤 Alternativa B) B) Porque podem liberar substâncias que contaminam o solo e a água. \n 🎤 Alternativa C) Porque atraem insetos. \n 🎤 Alternativa D) Porque aumentam a temperatura do ambiente. \n 🎤 Alternativa E) Porque impedem a reciclagem do papel. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸  PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            ...
            if pergunta_9_resposta_m == "B":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 10000,00! Valor acumulado: R$ 40000,00 \n Vamos prosseguir para a pergunta 10")
                input(" | ENTER | \n")
                Valor_Acumulado = 40000.0
                break

            if pergunta_9_resposta_m in ["A", "C", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou! \n\n O valor acumulado foi de R$ " + str(Valor_Acumulado) + " \n\n Obrigado por jogar o Cyber Mind Show, " + nome_usuario + "! \n\n | ENTER | \n")
                exit()
    ...
    def RESPOSTAS_PERGUNTA_10 (pergunta_10_resposta_m):
        ...
        while True:
            pergunta_10_resposta_m = input("🎤 PERGUNTA 10:\n\n Qual dos materiais abaixo pode estar presente em algumas baterias e exigir descarte adequado devido aos riscos ambientais?"" \n\n 🎤 Alternativa A) Areia. \n 🎤 Alternativa B) Chumbo. \n 🎤 Alternativa C) Lítio. \n 🎤 Alternativa D) Níquel. \n 🎤 Alternativa E) Mercúrio. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸  PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            ...
            if pergunta_10_resposta_m == "E":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 10000,00! Valor acumulado: R$ 50000,00")
                input(" | ENTER | \n")
                Valor_Acumulado = 50000.0
                break

            if pergunta_10_resposta_m in ["A", "C", "B", "D"]:
                print("\n🎤 Resposta incorreta! O jogo acabou! \n\n O valor acumulado foi de R$ " + str(Valor_Acumulado) + " \n\n Obrigado por jogar o Cyber Mind Show, " + nome_usuario + "! \n\n | ENTER | \n")
                exit()
    ...
    def RESPOSTAS_PERGUNTA_11 (pergunta_11_resposta_m):
        ...
        while True:
            pergunta_11_resposta_m = input("🎤 PERGUNTA 11:\n\n A queima de combustíveis fósseis contribui principalmente para qual problema ambiental global?\n\n 🎤 Alternativa A) Formação de terremotos. \n 🎤 Alternativa B) Aumento da camada de ozônio. \n 🎤 Alternativa C) Aquecimento global devido à emissão de gases de efeito estufa. \n 🎤 Alternativa D) Crescimento das florestas tropicais. \n 🎤 Alternativa E) Diminuição da temperatura média da Terra. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            ...
            if pergunta_11_resposta_m == "U":
                if Ajuda_Universitarios > 0:
                    Ajuda_Universitarios -= 1
                    print(input("\n 🎤 Você pediu a ajuda dos Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                    print(" 🎓 A queima de combustíveis fósseis contribui principalmente para o aquecimento global devido à emissão de gases de efeito estufa. (C) \n\n ")
                    print(input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))
                else:
                    print(input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))
            ...
            if pergunta_11_resposta_m == "C":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 20000,00! Valor acumulado: R$ 70000,00 \n Vamos prosseguir para a pergunta 12")
                input(" | ENTER | \n")
                Valor_Acumulado = 70000.0
                break
    ...
    def RESPOSTAS_PERGUNTA_12 (pergunta_12_resposta_m):
        ...
        while True:
            pergunta_12_resposta_m = input("🎤 PERGUNTA 12:\n\n Qual gás é emitido em grande quantidade pela queima de gasolina e diesel e está diretamente relacionado ao efeito estufa?\n\n 🎤 Alternativa A) Dióxido de carbono (CO₂) \n 🎤 Alternativa B) Oxigênio (O₂) \n 🎤 Alternativa C) Nitrogênio (N₂) \n 🎤 Alternativa D) Ozônio (O₃) \n 🎤 Alternativa E) Metano (CH₄) \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            ...
            if pergunta_12_resposta_m == "U":
                if Ajuda_Universitarios > 0:
                    Ajuda_Universitarios -= 1
                    print(input("\n 🎤 Você pediu a ajuda dos Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                    print(" 🎓 O dióxido de carbono (CO₂) é o gás emitido em grande quantidade pela queima de gasolina e diesel e está diretamente relacionado ao efeito estufa. (A) \n\n ")
                    print(input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))
                else:
                    print(input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))

            if pergunta_12_resposta_m == "A":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 20000,00! Valor acumulado: R$ 90000,00 \n Vamos prosseguir para a pergunta 13 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 90000.0
                break

            if pergunta_12_resposta_m in ["B", "C", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_13 (pergunta_13_resposta_m):
        global Ajuda_plateia
        global Ajuda_Universitarios
        global Valor_Acumulado

        while True:
            pergunta_13_resposta_m = input("🎤 PERGUNTA 13:\n\n Além dos impactos ambientais, a utilização de combustíveis fósseis pode causar qual problema social?\n\n 🎤 Alternativa A) Redução da necessidade de transporte. \n 🎤 Alternativa B) Problemas respiratórios na população devido à poluição do ar. \n 🎤 Alternativa C) Aumento da qualidade da água dos rios. \n 🎤 Alternativa D) Crescimento da biodiversidade urbana. \n 🎤 Alternativa E) Eliminação dos resíduos sólidos. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_13_resposta_m = pergunta_13_resposta_m.upper()

            if pergunta_13_resposta_m == "P":
                if Ajuda_plateia > 0:
                    Ajuda_plateia -= 1
                    print(input("\n 🎤 Você pediu a ajuda da Plateia: \n Eles não têm certeza de qual seja a certa, então boa sorte! \n\n | ENTER | "))
                    print(" 🥸 É Alternativa (B)! \n 🥸 Claro que é (B)! \n 🥸 Óbvio que é (B)! \n\n")
            ...
            if pergunta_13_resposta_m == "U":
                if Ajuda_Universitarios > 0:
                    Ajuda_Universitarios -= 1
                    print(input("\n 🎤 Você pediu a ajuda dos Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                    print(" 🎓 A população sofre com o gás poluído, correto (B) \n\n ")
                    print(input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))
                else:
                    print(input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))

            if pergunta_13_resposta_m == "B":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 20000,00! Valor acumulado: R$ 110000,00 \n Vamos prosseguir para a pergunta 14 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 110000.0
                break

            if pergunta_13_resposta_m in ["A", "C", "D", "E"]:
                 print("\n🎤 Resposta incorreta! O jogo acabou!")
                 print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                 print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                 input("\n| ENTER |")
    ...
    RESPOSTAS_PERGUNTA_13("")

    import os
    os.system("cls") 

    def RESPOSTAS_PERGUNTA_14 (pergunta_14_resposta_m):
        global Ajuda_plateia
        global Ajuda_Universitarios
        global Valor_Acumulado

        while True:
            pergunta_14_resposta_m = input("🎤 PERGUNTA 14:\n\n Uma das vantagens dos biocombustíveis, como o etanol e o biodiesel, é:\n\n 🎤 Alternativa A) Produzirem mais resíduos tóxicos que os combustíveis fósseis. \n 🎤 Alternativa B) Não emitirem nenhum gás poluente. \n 🎤 Alternativa C) Possuírem reservas infinitas na natureza. \n 🎤 Alternativa D) Eliminarem completamente o efeito estufa. \n 🎤 Alternativa E) Serem fontes renováveis de energia. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_14_resposta_m = pergunta_14_resposta_m.upper()

            if pergunta_14_resposta_m == "P":
                if Ajuda_plateia > 0:
                    Ajuda_plateia -= 1
                    print(input("\n 🎤 Você pediu a ajuda da Plateia: \n Eles não têm certeza de qual seja a certa, então boa sorte! \n\n | ENTER | "))
                    print(" 🥸 É Alternativa (E)! \n 🥸 Claro que é (E)! \n 🥸 Óbvio que é (E)! \n\n")
            ...
            if pergunta_14_resposta_m == "U":
                if Ajuda_Universitarios > 0:
                     Ajuda_Universitarios -= 1
                     print(input("\n 🎤 Você pediu a ajuda dos Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                     print(" 🎓 Serem fontes renováveis, letra (E) \n\n ")
                     print(input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))
                else:
                    print(input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))

            if pergunta_14_resposta_m == "E":
                 print("\n🎤 Resposta correta!")
                 print("✅ Você ganhou R$ 130000,00! Valor acumulado: R$ 130000,00 \n Vamos prosseguir para a pergunta 15 ")
                 input(" | ENTER | \n")
                 Valor_Acumulado = 130000.0
                 break

            if pergunta_14_resposta_m in ["A", "B", "D", "C"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    RESPOSTAS_PERGUNTA_14("")

    import os
    os.system("cls") 

    def RESPOSTAS_PERGUNTA_15 (pergunta_15_resposta_m):
        global Ajuda_plateia
        global Ajuda_Universitarios
        global Valor_Acumulado

        while True:
            pergunta_15_resposta_m = input("🎤 PERGUNTA 15:\n\nO derramamento de petróleo nos oceanos pode causar:\n\n 🎤 Alternativa A) Aumento da reprodução dos peixes \n 🎤 Alternativa B) Melhoria da qualidade da água. \n 🎤 Alternativa C) Crescimento acelerado dos corais. \n 🎤 Alternativa D) Danos aos ecossistemas marinhos e à vida aquática. \n 🎤 Alternativa E) Redução do oxigênio na água. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_15_resposta_m = pergunta_15_resposta_m.upper()

            if pergunta_15_resposta_m == "P":
                if Ajuda_plateia > 0:
                    Ajuda_plateia -= 1
                    print(input("\n 🎤 Você pediu a ajuda da Plateia: \n Eles não têm certeza de qual seja a certa, então boa sorte! \n\n | ENTER | "))
                    print(" 🥸 É Alternativa (D)! \n 🥸 Claro que é (D)! \n 🥸 Óbvio que é (D)! \n\n")
            ...
            if pergunta_15_resposta_m == "U":
                if Ajuda_Universitarios > 0:
                    Ajuda_Universitarios -= 1
                    print(input("\n 🎤 Você pediu a ajuda dos Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                    print(" 🎓 Prejudica a vida marinha, letra (D) \n\n ")
                    print(input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))
                else:
                    print(input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))

            if pergunta_15_resposta_m == "D":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 150000,00! Valor acumulado: R$ 150000,00 \n\n Parabéns por ter passado da pergunta de nível intermediário!!! \nAgora vamos pra dificuldade dificil \nO tema agora será Combustíveis Biodegradáveis! \n Vamos prosseguir para a pergunta 16 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 150000.0
                break

            if pergunta_15_resposta_m in ["B", "C", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_16 (pergunta_16_resposta_m):
        ...
        while True:
            pergunta_16_resposta_m = input("🎤 PERGUNTA 16:\n\nOs combustíveis biodegradáveis são considerados alternativas mais sustentáveis aos combustíveis fósseis principalmente porque:\n\n 🎤 Alternativa A) São produzidos exclusivamente a partir de minerais. \n 🎤 Alternativa B) Possuem capacidade ilimitada de geração de energia. \n 🎤 Alternativa C) Podem ser decompostos naturalmente e geralmente são obtidos de fontes renováveis. \n 🎤 Alternativa D) Não liberam nenhum gás durante sua utilização. \n 🎤 Alternativa E) Não exigem processos industriais para sua produção. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_16_resposta_m = pergunta_16_resposta_m.upper()
            ...
            if pergunta_16_resposta_m == "U":
                if Ajuda_Universitarios > 0:
                    Ajuda_Universitarios -= 1
                    print(input("\n 🎤 Você pediu a ajuda dos Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                    print(" 🎓 Todas erradas, menos a (C) \n\n ")
                    print(input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))
                else:
                    print(input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))

            if pergunta_16_resposta_m == "C":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 30000,00! Valor acumulado: R$ 180000,00 \n Vamos prosseguir para a pergunta 16 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 180000.0
                break

            if pergunta_16_resposta_m in ["B", "A", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_17 (pergunta_17_resposta_m):
        ...
        while True:
            pergunta_17_resposta_m = input("🎤 PERGUNTA 17:\n\nQual das alternativas apresenta apenas exemplos de combustíveis biodegradáveis?\n\n 🎤 Alternativa A) Gasolina e diesel mineral. \n 🎤 Alternativa B) Etanol e biodiesel. \n 🎤 Alternativa C) Querosene e gasolina. \n 🎤 Alternativa D) Diesel mineral e gás natural. \n 🎤 Alternativa E) Carvão mineral e petróleo. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_17_resposta_m = pergunta_17_resposta_m.upper()
            ...
            if pergunta_17_resposta_m == "U":
                if Ajuda_Universitarios > 0:
                    Ajuda_Universitarios -= 1
                    print(input("\n 🎤 Você pediu a ajuda dos Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                    print(" 🎓 Todas erradas, menos a (B) \n\n ")
                    print(input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))
                else:
                    print(input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))

            if pergunta_17_resposta_m == "B":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 30000,00! Valor acumulado: R$ 210000,00 \n Vamos prosseguir para a pergunta 16 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 210000.0
                break

            if pergunta_17_resposta_m in ["C", "A", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_18 (pergunta_18_resposta_m):
        ...
        while True:
            pergunta_18_resposta_m = input("🎤 PERGUNTA 18:\n\nEmbora os combustíveis biodegradáveis apresentem vantagens ambientais, um desafio associado à sua produção em larga escala é:\n\n 🎤 Alternativa A) A impossibilidade de utilização em veículos. \n 🎤 Alternativa B) A ausência de matéria-prima para sua fabricação. \n 🎤 Alternativa C) A competição pelo uso de terras destinadas à produção de alimentos. \n 🎤 Alternativa D) A produção exclusiva em regiões polares. \n 🎤 Alternativa E) O aumento da camada de ozônio. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_18_resposta_m = pergunta_18_resposta_m.upper()
            ...
            if pergunta_18_resposta_m == "C":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 30000,00! Valor acumulado: R$ 240000,00 \n Vamos prosseguir para a pergunta 16 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 240000.0
                break

            if pergunta_18_resposta_m in ["B", "A", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_19 (pergunta_19_resposta_m):
        ...
        while True:
            pergunta_19_resposta_m = input("🎤 PERGUNTA 19:\n\nO biodiesel é produzido principalmente a partir de:\n\n 🎤 Alternativa A) Rochas sedimentares. \n 🎤 Alternativa B) Minérios metálicos. \n 🎤 Alternativa C) Petróleo refinado. \n 🎤 Alternativa D) Óleos vegetais e gorduras animais. \n 🎤 Alternativa E) Carvão mineral. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_19_resposta_m = pergunta_19_resposta_m.upper()
            ...
            if pergunta_19_resposta_m == "U":
                if Ajuda_Universitarios > 0:
                    Ajuda_Universitarios -= 1
                    print(input("\n 🎤 Você pediu a ajuda dos Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                    print(" 🎓 Todas erradas, menos a (D) \n\n ")
                    print(input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))
                else:
                    print(input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))

            if pergunta_19_resposta_m == "D":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 30000,00! Valor acumulado: R$ 270000,00 \n Vamos prosseguir para a pergunta 16 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 270000.0
                break

            if pergunta_19_resposta_m in ["B", "A", "C", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_20 (pergunta_20_resposta_m):
        ...
        while True:
            pergunta_20_resposta_m = input("🎤 PERGUNTA 20:\n\nEm relação às emissões de carbono, os combustíveis biodegradáveis podem contribuir para a redução do impacto ambiental porque:\n\n 🎤 Alternativa A) O carbono liberado durante a combustão foi previamente absorvido pelas plantas utilizadas como matéria-prima. \n 🎤 Alternativa B) Eles não realizam combustão. \n 🎤 Alternativa C) Produzem apenas oxigênio durante sua utilização. \n 🎤 Alternativa D) Impedem totalmente o efeito estufa. \n 🎤 Alternativa E) Não contêm compostos químicos em sua composição. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_20_resposta_m = pergunta_20_resposta_m.upper()
            ...
            if pergunta_20_resposta_m == "U":
                if Ajuda_Universitarios > 0:
                    Ajuda_Universitarios -= 1
                    print(input("\n 🎤 Você pediu a ajuda dos Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                    print(" 🎓 Todas erradas, menos a (A) \n\n ")
                    print(input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))
                else:
                    print(input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))

            if pergunta_20_resposta_m == "A":
                    print("\n🎤 Resposta correta!")
                    print("✅ Você ganhou R$ 30000,00! Valor acumulado: R$ 300000,00 \n Vamos prosseguir para a pergunta 16 ")
                    input(" | ENTER | \n")
                    Valor_Acumulado = 300000.0
                    break

            if pergunta_20_resposta_m in ["B", "D", "C", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_21 (pergunta_21_resposta_m):
        ...
        while True:
            pergunta_21_resposta_m = input("🎤 PERGUNTA 21:\nTema de: Aterros Sanitários\n\nQual é a principal função do sistema de impermeabilização presente em um aterro sanitário?\n\n🎤 Alternativa A) Impedir que o chorume contamine o solo e os lençóis freáticos. \n 🎤 Alternativa B) Facilitar a circulação de gases no solo. \n 🎤 Alternativa C) Eliminar completamente a produção de chorume. \n 🎤 Alternativa D) Aumentar a velocidade de decomposição dos resíduos. \n 🎤 Alternativa E) Reduzir a quantidade de resíduos recebidos. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_21_resposta_m = pergunta_21_resposta_m.upper()
            ...
            if pergunta_21_resposta_m == "A":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 40000,00! Valor acumulado: R$ 340000,00 \n Vamos prosseguir para a pergunta 16 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 340000.0
                break

            if pergunta_21_resposta_m in ["B", "D", "C", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_22 (pergunta_22_resposta_m):
        ...
        while True:
            pergunta_22_resposta_m = input("🎤 PERGUNTA 22:\n\nEm relação às emissões de carbono, os combustíveis biodegradáveis podem contribuir para a redução do impacto ambiental porque:\n\n 🎤 Alternativa A) Neutraliza a ação do dióxido de carbono. \n 🎤 Alternativa B) Impede a decomposição da matéria orgânica. \n 🎤 Alternativa C) É responsável pela formação da camada de ozônio. \n 🎤 Alternativa D) Possui elevado potencial de contribuição para o efeito estufa. \n 🎤 Alternativa E) Elimina a necessidade de reciclagem. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_22_resposta_m = pergunta_22_resposta_m.upper()
            ...
            if pergunta_22_resposta_m == "D":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 40000,00! Valor acumulado: R$ 380000,00 \n Vamos prosseguir para a pergunta 16 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 380000.0
                break

            if pergunta_22_resposta_m in ["B", "A", "C", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_23 (pergunta_23_resposta_m):
        ...
        while True:
            pergunta_23_resposta_m = input("🎤 PERGUNTA 23:\n\nO chorume gerado em aterros sanitários é caracterizado como:\n\n 🎤 Alternativa A) Uma camada impermeável aplicada no solo. \n 🎤 Alternativa B) Um combustível utilizado para gerar energia. \n 🎤 Alternativa C) Um líquido resultante da decomposição dos resíduos e da infiltração da água da chuva. \n 🎤 Alternativa D) Um material sólido utilizado na compactação dos resíduos. \n 🎤 Alternativa E) Um gás liberado durante a decomposição do lixo. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_23_resposta_m = pergunta_23_resposta_m.upper()
            ...
            if pergunta_23_resposta_m == "C":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 40000,00! Valor acumulado: R$ 420000,00 \n Vamos prosseguir para a pergunta 16 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 420000.0
                break

            if pergunta_23_resposta_m in ["B", "D", "A", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_24 (pergunta_24_resposta_m):
        ...
        while True:
            pergunta_24_resposta_m = input("🎤 PERGUNTA 24:\n\nMesmo sendo uma alternativa mais segura que os lixões, os aterros sanitários apresentam uma limitação importante relacionada:\n\n 🎤 Alternativa A) À impossibilidade de armazenar resíduos sólidos. \n 🎤 Alternativa B) À sua vida útil limitada devido ao acúmulo contínuo de resíduos. \n 🎤 Alternativa C) À incapacidade de controlar vetores de doenças. \n 🎤 Alternativa D) À necessidade de funcionamento sem fiscalização ambiental. \n 🎤 Alternativa E) À proibição da compactação do lixo. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_24_resposta_m = pergunta_24_resposta_m.upper()
            ...
            if pergunta_24_resposta_m == "B":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 40000,00! Valor acumulado: R$ 460000,00 \n Vamos prosseguir para a pergunta 16 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 460000.0
                break

            if pergunta_24_resposta_m in ["A", "D", "C", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_25 (pergunta_25_resposta_m):
        ...
        while True:
            pergunta_25_resposta_m = input("🎤 PERGUNTA 25:\n\nA captura e o aproveitamento energético do biogás produzido em aterros sanitários representam uma vantagem porque:\n\n 🎤 Alternativa A) Tornam desnecessária a reciclagem dos materiais descartados. \n 🎤 Alternativa B) Impedem totalmente a geração de chorume. \n 🎤 Alternativa C) Substituem a coleta seletiva de resíduos. \n 🎤 Alternativa D) Eliminam completamente a produção de resíduos sólidos. \n 🎤 Alternativa E) Transformam gases poluentes em uma fonte de energia aproveitável. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_25_resposta_m = pergunta_25_resposta_m.upper()
            ...
            if pergunta_25_resposta_m == "E":
                print("\n🎤 Resposta correta!")
                print("✅ Você ganhou R$ 40000,00! Valor acumulado: R$ 500000,00 \n Vamos prosseguir para a pergunta 16 ")
                input(" | ENTER | \n")
                Valor_Acumulado = 500000.0
                break

            if pergunta_25_resposta_m in ["B", "D", "C", "A"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_26 (pergunta_26_resposta_m):
        ...
        while True:
            ...
            print("Você está de frente com a pergunta de UM MILHÃO DE REAIS.")
            print("\nEsta é a sua ÚLTIMA CHANCE de mudar de ideia:")
            input("   Lembre-se: se você errar a resposta, perderá tudo e sairá com R$ 0,00!\n\n |ENTER|" )
            import os
            os.system("cls")
            pergunta_26_resposta_m = input("🎤 PERGUNTA 26:\n\nDurante 20 anos, uma cidade utilizou um lixão a céu aberto próximo a um rio. Posteriormente, o local foi transformado em um aterro sanitário moderno com impermeabilização do solo, coleta de chorume e aproveitamento energético do biogás. Após alguns anos, pesquisadores observaram que a água subterrânea da região ainda apresentava sinais de contaminação.\nQual é a explicação mais provável para esse fenômeno?\n\n 🎤 Alternativa A) O sistema de impermeabilização aumentou a infiltração de poluentes no solo. \n 🎤 Alternativa B) O metano produzido pelo aterro dissolveu-se completamente na água subterrânea, tornando-a imprópria para consumo. \n 🎤 Alternativa C) A contaminação pode ser consequência dos resíduos depositados durante o período em que o local funcionava como lixão, cujos impactos ambientais podem persistir por muitos anos. \n 🎤 Alternativa D) A geração de energia a partir do biogás produz obrigatoriamente substâncias tóxicas que contaminam os lençóis freáticos. \n 🎤 Alternativa E) O tratamento do chorume aumenta sua toxicidade e facilita sua infiltração no solo. \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_26_resposta_m = pergunta_26_resposta_m.upper()
            ...
            if pergunta_26_resposta_m == "U":
                if Ajuda_Universitarios > 0:
                    Ajuda_Universitarios -= 1
                    print(input("\n 🎤 Você pediu a ajuda dos Universitários: \n Veja o que eles dirão \n\n | ENTER | "))
                    print(" 🎓 Todas erradas, menos a (???) \n\n ")
                    print(input(" 🎤 " + nome_usuario + ", Após receber a ajuda dos Universitários: \n diga qual é a alternativa correta \n\n | [ENTER] PARA VER NOVAMENTE AS RESPOSTAS | \n"))
                else:
                    print(input("\n 🎤 Você não tem mais ajudas dos Universitários disponíveis! \n\n | ENTER | \n"))

            if pergunta_26_resposta_m == "C":
                print("\n🎤 Resposta correta!")
                print("🎉🎉 EXTRAORDINÁRIO!!! HISTÓRIA FOI FEITA!!! 🎉🎉")
                print(f"🏆 VOCÊ ACABA DE ACERTAR A PERGUNTA 26 E GANHOU 💵 R$ 1.000.000,00 !!! 🏆")
                input("\n| ENTER PARA FINALIZAR O JOGO COMO UM NOVO MILIONÁRIO | \n")
            ...
            if pergunta_26_resposta_m in ["B", "D", "A", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind Show, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    def RESPOSTAS_PERGUNTA_13 (pergunta_13_resposta_m):
        ...
        while True:
            pergunta_13_resposta_m = input("🎤 PERGUNTA 13:\n\n Qual é o valor de π (pi) aproximadamente?\n\n 🎤 Alternativa A) 3,14159 \n 🎤 Alternativa B) 2,71828 \n 🎤 Alternativa C) 1,61803 \n 🎤 Alternativa D) 0,57721 \n 🎤 Alternativa E) 1,41421 \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_13_resposta_m = pergunta_13_resposta_m.upper()
            ...
            if pergunta_13_resposta_m in ["C", "B", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Show do Milhão, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    RESPOSTAS_PERGUNTA_13(pergunta_13_resposta_m = "")
    ...
    def RESPOSTAS_PERGUNTA_14 (pergunta_14_resposta_m):
        ...
        while True:
            pergunta_14_resposta_m = input("🎤 PERGUNTA 14:\n\n Uma pirâmide possui área da base igual a 60 cm² e altura de 9 cm. Qual é o seu volume?\n\n 🎤 Alternativa A) 120 cm³ \n 🎤 Alternativa B) 150 cm³ \n 🎤 Alternativa C) 240 cm³ \n 🎤 Alternativa D) 180 cm³ \n 🎤 Alternativa E) 540 cm³ \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_14_resposta_m = pergunta_14_resposta_m.upper()
            ...
            if pergunta_14_resposta_m in ["A", "B", "C", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Show do Milhão, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    RESPOSTAS_PERGUNTA_14(pergunta_14_resposta_m = "")
    ...
    def RESPOSTAS_PERGUNTA_15 (pergunta_15_resposta_m):
        ...
        while True:
            pergunta_15_resposta_m = input("🎤 PERGUNTA 15:\n\n Uma caixa d'água possui capacidade de 2 m³. Sabendo que 1 m³ = 1000 litros, qual é a capacidade da caixa em litros?\n\n 🎤 Alternativa A) 200 litros \n 🎤 Alternativa B) 2000 litros \n 🎤 Alternativa C) 20000 litros \n 🎤 Alternativa D) 4000 litros \n 🎤 Alternativa E) 6000 litros \n\n | PARA RESPONDER DIGITE [A/B/C/D/E] | \n | PARA CHAMAR A 🥸 PLATEIA PRESSIONE [P] | \n | PARA CHAMAR OS 🎓 UNIVERSITÁRIOS PRESSIONE [U] | \n\n | ENTER | \n\n 👤 ")
            pergunta_15_resposta_m = pergunta_15_resposta_m.upper()
            ...
            if pergunta_15_resposta_m in ["A", "C", "D", "E"]:
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Show do Milhão, " + nome_usuario + "!")
                input("\n| ENTER |")
    ...
    RESPOSTAS_PERGUNTA_15(pergunta_15_resposta_m = "")
...
#===================================================
    ...
    def RESPOSTAS_PERGUNTA_20 (pergunta_20_resposta_m = ""):
        ...
        # AJUDA DOS UNIVERSITÁRIOS
                ...
                print("\n🎤 Resposta incorreta! O jogo acabou!")
                print("\nO valor acumulado foi de R$ " + str(Valor_Acumulado))
                print("\nObrigado por jogar o Cyber Mind, " + nome_usuario + "!")
                input("\n| ENTER |")
                exit()
